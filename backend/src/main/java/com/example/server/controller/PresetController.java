...
public class PresetController {
    ...
    // FIXED: Changed mapping from "/create/preset" to "/preset/create" to match PredefinedQuiz.jsx
    ...
    public ResponseEntity<?> deletePreset(@RequestParam("id") String id, Authentication authentication) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(body); // Use OK (200) instead of NO_CONTENT if providing a JSON response body
    }
    ...
    public ResponseEntity<?> getPresetById(@RequestParam("id") String id, Authentication authentication) {
