...
//                </h1>
//
//                <p style="margin:0;font-size:17px;opacity:.9;">
...
//            helper.setSubject("Verify Your Quiz Application Account");
//            String text = """
...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String token) {
        ...
        // Your exact HTML template string remains unchanged
        String html = """
                <!DOCTYPE html>
                <html>
                <head>
        ...
        try {
            ...
            sender.setName("Quiz Application");

            // 2. Define Recipient(s)
            SendSmtpEmailTo recipient = new SendSmtpEmailTo();
            recipient.setEmail(to);

            // 3. Assemble the HTTP Request Payload
            ...
            // 4. Fire the HTTP POST request to Brevo
